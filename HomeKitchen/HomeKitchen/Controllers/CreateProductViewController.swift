...
class CreateProductViewController: UIViewController {
  ...
  var imageUrl: String = Helper.defaultImageUrl
...
extension CreateProductViewController {
  ...
  func postProductToServer() {
    ...
    NetworkingService.sharedInstance.createProduct(productName: productName, productPrice: productPrice, type: type, imageUrl: self.imageUrl, status: status, recipe: recipe) {
